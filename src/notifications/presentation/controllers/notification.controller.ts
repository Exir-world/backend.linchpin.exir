...
export class NotificationController {
    ...
    async getAll(@Query() dto: GetNotificationsDto) {
        return this.queryBus.execute(new GetNotificationsQuery(dto.userId, dto.page, dto.limit));
    }
    ...
    async markAsRead(@Body() dto: MarkAsReadDto) {
        return this.commandBus.execute(new MarkAsReadCommand(dto.ids));
    }
}
